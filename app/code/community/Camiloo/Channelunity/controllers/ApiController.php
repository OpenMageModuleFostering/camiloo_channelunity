    ...
    public function doApiProcess($xml, $testMode = false)
    {
        ...
        switch ($type) {
            ...
            case "ProductDataDelta":
                Mage::getModel('channelunity/orders')->shipmentCheck($request);
                break;
            ...
            case "OrderCancellationsCheck":
                // Pull cancellation data from orders since a given ID
                Mage::getModel('channelunity/orders')->orderCancellationsCheck($request);
                break;
        }
