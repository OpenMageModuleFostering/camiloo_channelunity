...
XML;
	...
	/**
	 * Returns an array of store codes to which to limit the products imported into CU.
	 * An empty array (default) will mean all products get sent to CU.
	 */
	protected function getStoresToLimitTo() {
		return array();
	}
}